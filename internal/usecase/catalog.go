...
func (uc *CatalogUseCase) ListCourses(search, category string, page, pageSize int) []domain.Course {
	courses, _, err := uc.repo.GetCourses(search, category, page, pageSize)
	if err != nil {
