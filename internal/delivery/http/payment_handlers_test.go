...
func (s *paymentStubCatRepo) Create(_ context.Context, course domain.Course) (domain.Course, error) {
	return course, nil
}

func (s *paymentStubCatRepo) Update(_ context.Context, course domain.Course) (domain.Course, error) {
	return course, nil
}
